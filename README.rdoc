...
It's supposed you should change your existed codes by yourself with newer version of authlogic_bundle or accessory plugins if this step is needed.
...
If you want to update the authlogic_bundle, you can
  ...
  $ cd ../../..
  $ git commit -a -m 'update authlogic_bundle submodule'
