...
This plugin will help you build up authentication/authorization system easily. You can also customize it by rails builtin engines' way.
...
The Role-Based Access Control (RBAC) is introdued, and you can design the authorization rules in first place. Here gives sample rules.
